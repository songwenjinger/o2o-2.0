...
public class QiNiuYunFileUtils {
    ...
    private static final String ACCESS_KEY= "SHRabCkAK7mI1geUvJ2oaOVY_VQ-hd3dWAGTWL85";
    private static final String SECRET_KEY= "m4yLIN0j0APVyZKB6kUZJeUIlbT5i82j0BTQD2Rv";
    private static final String BUCKET= "o2o_aha";
    private static final String domainOfBucket = "http://pohymnwyg.bkt.clouddn.com";
